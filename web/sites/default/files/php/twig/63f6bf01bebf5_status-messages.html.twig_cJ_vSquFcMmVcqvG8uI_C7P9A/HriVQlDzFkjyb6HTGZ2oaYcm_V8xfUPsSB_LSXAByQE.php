...
/* themes/contrib/january_theme/templates/misc/status-messages.html.twig */
class __TwigTemplate_34e0b2d37b6e75784267135b4be0cc48 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 22
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("january/messages"), "html", null, true);
        echo "
            ...
            <h2 class=\"visually-hidden\">";
              ...
              <div class=\"messages__icon\">
                ...
                if (($context["type"] == "error")) {
                    // line 47
                    echo "                  ";
                    $this->loadTemplate("@january/../images/error.svg", "themes/contrib/january_theme/templates/misc/status-messages.html.twig", 47)->display($context);
                    // line 48
                    echo "                ";
                } elseif (($context["type"] == "warning")) {
                    // line 49
                    echo "                  ";
                    $this->loadTemplate("@january/../images/warning.svg", "themes/contrib/january_theme/templates/misc/status-messages.html.twig", 49)->display($context);
                    // line 50
                    echo "                ";
                } elseif (($context["type"] == "status")) {
                    // line 51
                    echo "                  ";
                    $this->loadTemplate("@january/../images/status.svg", "themes/contrib/january_theme/templates/misc/status-messages.html.twig", 51)->display($context);
                    // line 52
                    echo "                ";
                } elseif (($context["type"] == "info")) {
                    // line 53
                    echo "                  ";
                    $this->loadTemplate("@january/../images/info.svg", "themes/contrib/january_theme/templates/misc/status-messages.html.twig", 53)->display($context);
                    // line 54
                    echo "                ";
                }
                // line 55
...
";
    ...
    {
        return "themes/contrib/january_theme/templates/misc/status-messages.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/january_theme/templates/misc/status-messages.html.twig", "/app/web/themes/contrib/january_theme/templates/misc/status-messages.html.twig");
    }
