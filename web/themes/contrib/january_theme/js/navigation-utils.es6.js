...
((Drupal) => {
  ...
  Drupal.january.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      'Drupal.january.stickyHeaderState',
      JSON.stringify(item),
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem('Drupal.january.stickyHeaderState');
      return false;
    }
    return item.value;
  }
